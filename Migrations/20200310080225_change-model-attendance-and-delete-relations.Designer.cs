...
namespace HR_App.Migrations
{
    ...
    [Migration("20200310080225_change-model-attendance-and-delete-relations")]
    partial class changemodelattendanceanddeleterelations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HR_App.Models.LeaveRequest", b =>
                {
                    b.HasOne("HR_App.Models.Employees", null)
                        .WithMany("leaverequest")
                        .HasForeignKey("EmployeesId");

                    b.HasOne("HR_App.Models.LeaveRequest", "leaveRequest")
                        .WithMany()
                        .HasForeignKey("LeaveReqId");
                });
